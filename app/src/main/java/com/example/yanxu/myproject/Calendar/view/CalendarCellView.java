...
package com.example.yanxu.myproject.Calendar.view;
...
import com.example.yanxu.myproject.Calendar.model.MonthCellDescriptor;
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isMark) {
            ...
            canvas.drawCircle(getWidth() / 2, getWidth() - 20, 3.0f, paint);
        }
        if (isMarkText) {
            paint.setColor(0xff3e8bda);
            canvas.drawCircle(getWidth() / 2, getWidth() - 20, 3.0f, paint);
        }
    }
